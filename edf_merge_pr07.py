...
Usage (all absolute paths):
    python edf_merge_pr07.py ~/ray/ucsf/data_store0/presidio/nihon_kohden/PR07 ~/ray/ucsf/data_store0/presidio/nihon_kohden/PR07/catalogs/sub-PR07_edf-catalog.csv out-PR07-5.7 --local
    submit_job -q pia-batch.q -c 8 -m 40 -o /userdata/rzhao/results.txt -n pr07 -x /userdata/rzhao/newenv/bin/python3 /userdata/rzhao/edf-merger/edf_merge_pr07.py
